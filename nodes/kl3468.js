/**
 * KL3468 — 8-ch analog input (e.g., higher-resolution), similar mapping to KL3208
 * Inputs / Outputs are identical to KL3208.
 */
module.exports = function(RED){
  function KL3468Node(cfg){
    ...
    let MAP = {
      ...
      pattern: cfg.pattern || "interleaved-status-data"
    };
    let SETTINGS = {
    ...
    function calcDataIndex(ch){ return MAP.startIndex + ch * MAP.step; }
    function calcStatusIndex(ch){ return (MAP.pattern === "interleaved-status-data") ? calcDataIndex(ch) - 1 : null; }
